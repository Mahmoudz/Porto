...
This is not version 2 of [Porto SAP](/docs/Intro). It is a separate architecture for teams who let agents own the codebase.

The full specification, the structure, the conventions, and the way it all fits together, is in **private testing** and shared directly. See **[Early Access](/ai/Early%20Access)**.
